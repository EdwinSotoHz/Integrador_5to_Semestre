...
interface g 0/1.10
 ...
 no ip address
 ipv6 address 2001:db8:3c4d:10::2/64 eui-64
 ipv6 enable
...
interface g 0/1.20
 ...
 no ip address
 ipv6 address 2001:db8:3c4d:20::2/64 eui-64
 ipv6 enable
 ipv6 nd managed-config-flag
 ipv6 nd prefix default no-advertise
 no shutdown
...
interface g 0/1.30
 ...
 no ip address
 ipv6 address 2001:db8:3c4d:30::2/64 eui-64
 ipv6 enable
 ipv6 nd managed-config-flag
 ipv6 nd prefix default no-advertise
 no shutdown
...
interface g 0/1.40
 ...
 no ip address
 ipv6 address 2001:db8:3c4d:40::2/64 eui-64
 ipv6 enable
 ipv6 nd managed-config-flag
 ipv6 nd prefix default no-advertise
 no shutdown
